...
(function () {
  ...
  function injectStyle() {
    UI.injectStyle('mg-holdem-css', [
      ...
      '.hd-seat.me .hd-seat-cards .hd-card{width:clamp(48px,14vw,68px);height:clamp(67px,19.5vw,95px);border-radius:9px;box-shadow:0 4px 12px rgba(0,0,0,.5),0 0 0 1px rgba(57,255,20,.25);}',
      ...
      '.hd-seats{display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:12px;}',
      '.hd-seat{position:relative;padding:11px;border-radius:14px;background:rgba(9,32,21,.6);border:1px solid var(--stroke);display:flex;flex-direction:column;gap:7px;transition:border-color .2s,box-shadow .2s,opacity .2s;}',
      '.hd-seat.me{border-color:var(--stroke-2);box-shadow:var(--glow-soft);background:rgba(9,32,21,.85);}',
