...
(function () {
  ...
  function injectStyle() {
    UI.injectStyle('mg-fivedraw-css', [
      ...
      '.fd-seat.me{border-color:var(--stroke-2);box-shadow:var(--glow-soft);background:rgba(9,32,21,.85);}',
      ...
      '.fd-corner{position:absolute;font-size:clamp(13px,3.7vw,16px);line-height:.9;text-align:center;font-weight:900;}',
      ...
      '.fd-c-rank{font-size:clamp(23px,6.4vw,32px);line-height:1;font-weight:900;}',
      '.fd-c-suit{font-size:clamp(18px,5vw,25px);line-height:1;}',
