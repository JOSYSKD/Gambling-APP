    ...
    return el('div', { class: 'pc-card pc-frame-' + fr.id }, [
      ...
      el('div', { class: 'pc-body' }, [
        ...
        el('div', { class: 'pc-stats' }, [
          ...
          // Eigene aktive Spielzeit (nur auf der eigenen Karte; App.Playtime misst nur mich).
          pcStat('⏱', (App.Playtime && App.Playtime.getFormatted) ? App.Playtime.getFormatted() : '—', 'Spielzeit')
        ] : []))
      ]))
    ]);
  }
